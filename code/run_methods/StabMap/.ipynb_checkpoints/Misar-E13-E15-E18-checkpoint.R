...
out_dir = '../../../results/embeddings/StabMap/Misar-E13-E15-E18/'
...
test_rna_count = read_mat(pj(data_dir, 'R/E13', 'rna'))
test_other_count = read_mat(pj(data_dir, 'R/E18', 'atac'))
...
head(rownames(as.matrix(logcounts(test_other))))
