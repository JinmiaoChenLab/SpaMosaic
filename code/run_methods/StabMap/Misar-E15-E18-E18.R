...
data_dir = '../../../data/processed/Misar-E15-E18-E18/'
out_dir = '../../../results/embeddings/StabMap/Misar-E15-E18-E18/'
...
mult_rna_count = read_mat(pj(data_dir, 'R/E15', 'rna'))
mult_other_count = read_mat(pj(data_dir, 'R/E15', 'atac'))
test_rna_count = read_mat(pj(data_dir, 'R/E18-rna', 'rna'))
test_other_count = read_mat(pj(data_dir, 'R/E18-atac', 'atac'))
