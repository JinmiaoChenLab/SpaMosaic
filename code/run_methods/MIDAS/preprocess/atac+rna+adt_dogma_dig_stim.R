...
base_dir <- "data/raw/atac+rna+adt/dogma/dig_stim"
frag_path <- pj(base_dir, "GSM5065533_DIG_STIM_fragments.tsv.gz")
count_path <- pj(base_dir, "GSM5065534_DIG_STIM_GExp_ATAC_filtered")
adt_path <- pj(base_dir, "GSM5065535_DIG_stim_ADT_allCounts.mtx.gz")
adt_bc_path <- pj(base_dir, "GSM5065535_DIG_stim_ADT_allCounts.barcodes.txt.gz")
adt_feat_path <- pj(base_dir, "GSM5065535_DIG_stim_ADT_allCounts.proteins.txt.gz")
