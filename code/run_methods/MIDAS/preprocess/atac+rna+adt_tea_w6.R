...
base_dir <- "data/raw/atac+rna+adt/tea/TEA-seq/w6"
frag_path <- pj(base_dir, "GSM5123954_X066-MP0C1W6_leukopak_perm-cells_tea_200M_atac_filtered_fragments.tsv.gz")
count_path <- pj(base_dir, "GSM5123954_X066-MP0C1W6_leukopak_perm-cells_tea_200M_cellranger-arc_filtered_feature_bc_matrix.h5")
adt_path <- pj(base_dir, "GSM5123954_X066-MP0C1W6_leukopak_perm-cells_tea_48M_adt_counts.csv.gz")
