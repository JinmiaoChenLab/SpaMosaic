...
count_path <- pj(base_dir, "GSM5123950_X066-MP0C1W2_leukopak_perm-cells_multiome_200M_cellranger-arc_filtered_feature_bc_matrix.h5")
...
atac <- subset(atac, subset =
    nCount_atac > 500 & nCount_atac < 15000 &
    nucleosome_signal < 2 &
    TSS.enrichment > 2
)
