...
base_dir <- "data/raw/atac+adt/asap/PBMC_stimulation/asap_stim"
frag_path <- pj(base_dir, "GSM4732111_CD28_CD3_stim_ASAP_fragments.tsv.gz")
adt_path <- pj(base_dir, "GSM4732112_CD28_CD3_stim_ASAP_ADT.tsv.gz")
