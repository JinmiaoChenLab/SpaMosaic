...
base_dir <- "data/raw/atac+rna+adt/dogma/lll_ctrl"
frag_path <- pj(base_dir, "GSM5065524_LLL_CTRL_fragments.tsv.gz")
count_path <- pj(base_dir, "GSM5065525_LLL_CTRL_GExp_ATAC_filtered")
adt_path <- pj(base_dir, "GSM5065526_LLL_ctrl_ADT_allCounts.mtx.gz")
adt_bc_path <- pj(base_dir, "GSM5065526_LLL_ctrl_ADT_allCounts.barcodes.txt.gz")
adt_feat_path <- pj(base_dir, "GSM5065526_LLL_ctrl_ADT_allCounts.proteins.txt.gz")
